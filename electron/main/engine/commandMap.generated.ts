...
export const COMMAND_MAP: Record<string, CommandTranslation> = {
  ...
  "pty_list": {"method":"pty.list","params":[]},
  "pty_read": {"method":"pty.read","params":[{"key":"pty_id","from":"pty_id","optional":false}]},
  "pty_resize": {"method":"pty.resize","params":[{"key":"pty_id","from":"pty_id","optional":false},{"key":"columns","from":"columns","optional":false},{"key":"rows","from":"rows","optional":false}]},
  "pty_shells": {"method":"pty.shells","params":[]},
  "pty_start": {"method":"pty.start","params":[{"key":"command","from":"command","optional":true},{"key":"cwd","from":"cwd","optional":true},{"key":"session_id","from":"session_id","optional":true},{"key":"columns","from":"columns","optional":true},{"key":"rows","from":"rows","optional":true}]},
  "pty_terminate": {"method":"pty.terminate","params":[{"key":"pty_id","from":"pty_id","optional":false}]},
  "pty_write": {"method":"pty.write","params":[{"key":"pty_id","from":"pty_id","optional":false},{"key":"data","from":"data","optional":false},{"key":"raw","from":"raw","optional":true}]},
  ...
  "schedule_create": {"method":"schedule.create","params":[{"key":"task","from":"task","optional":false}]},
  "schedule_delete": {"method":"schedule.delete","params":[{"key":"task_id","from":"task_id","optional":false}]},
  "schedule_get": {"method":"schedule.get","params":[{"key":"task_id","from":"task_id","optional":false}]},
  "schedule_grant": {"method":"schedule.grant","params":[{"key":"capability","from":"capability","optional":false},{"key":"target","from":"target","optional":true},{"key":"task_id","from":"task_id","optional":true},{"key":"session_id","from":"session_id","optional":true}]},
  "schedule_list": {"method":"schedule.list","params":[]},
  "schedule_run_now": {"method":"schedule.run_now","params":[{"key":"task_id","from":"task_id","optional":false}]},
  ...
  "skill_job_get": {"method":"skill.job.get","params":[{"key":"job_id","from":"job_id","optional":false}]},
  "skill_job_start": {"method":"skill.job.start","params":[{"key":"action","from":"action","optional":false},{"key":"source","from":"source","optional":true},{"key":"name","from":"name","optional":true},{"key":"expected_hash","from":"expected_hash","optional":true},{"key":"force","from":"force","optional":true}]},
  "skill_list": {"method":"skill.list","params":[{"key":"project_root","from":"project_root","optional":true}]},
  "skill_pending_approve": {"method":"skill.pending.approve","params":[{"key":"name","from":"name","optional":false}]},
  "skill_pending_list": {"method":"skill.pending.list","params":[]},
  "skill_pending_reject": {"method":"skill.pending.reject","params":[{"key":"name","from":"name","optional":false}]},
  "skill_read": {"method":"skill.read","params":[{"key":"name","from":"name","optional":false},{"key":"path","from":"path","optional":false},{"key":"offset","from":"offset","optional":true},{"key":"limit","from":"limit","optional":true}]},
  "skill_remove": {"method":"skill.remove","params":[{"key":"name","from":"name","optional":false}]},
  "skill_revert": {"method":"skill.revert","params":[{"key":"name","from":"name","optional":false}]},
  "skill_settings_get": {"method":"skill.settings.get","params":[]},
  "skill_settings_set": {"method":"skill.settings.set","params":[{"key":"auto_learn","from":"auto_learn","optional":false}]},
  "skill_write": {"method":"skill.write","params":[{"key":"name","from":"name","optional":false},{"key":"content","from":"content","optional":false}]},
  ...
  "turn_start": {"method":"session.turn.start","params":[{"key":"session_id","from":"session_id","optional":false},{"key":"message","from":"message","optional":false},{"key":"reasoning_effort","from":"reasoning_effort","optional":false},{"key":"attachments","from":"attachments","optional":false},{"key":"allow_unconfirmed_vision","from":"allow_unconfirmed_vision","optional":false,"fallback":false},{"key":"command","from":"command","optional":true}]},
  "turn_steer": {"method":"session.turn.steer","params":[{"key":"session_id","from":"session_id","optional":false},{"key":"message","from":"message","optional":false}]},
